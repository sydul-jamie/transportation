...
$dzEmailTo = "btcbd24@gmail.com";   // Receiver Email Address "btcbd@gmail.com" 
$dzEmailFrom   = "Bengal-Travel-Care Contact";
...
if(!empty($_POST) && $_POST['dzToDo'] == 'Contact')
{
	...
	$dzMailSubject = 'Bengal-Travel-Care|Contact Form: A Person want to contact';
	$dzMailMessage	= 	"
